...
class CamAL(object):
    ...
    def train(
        ...
        **training_kwargs,
        ...
        print("Ho superato l'assert nel train")
        ...
        if path is not None:
            import os
            os.makedirs(os.path.dirname(path), exist_ok=True)  # crea la cartella se non esiste
    ...
    def test(self, data_test, appliance_mean_on_power=None, scaler=None):
        ...
        #return {
        #    "Localization metrics": metric_softlabel,
        #    "Classification metrics": metric_classif,
        #}
